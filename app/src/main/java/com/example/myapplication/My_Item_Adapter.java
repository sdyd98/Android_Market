...
public class My_Item_Adapter extends RecyclerView.Adapter<My_Item_Adapter.MyViewHolder> {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View v) {
            super(v);
            TextView_titile = v.findViewById(R.id.My_Item_view_Name);
            TextView_content = v.findViewById(R.id.My_Item_view_Price);
            ImageView_title = v.findViewById(R.id.My_Item_view_Img);
    ...
    @Override
    public My_Item_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        // create a new view

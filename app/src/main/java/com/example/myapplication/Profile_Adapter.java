...
public class Profile_Adapter extends RecyclerView.Adapter<Profile_Adapter.MyViewHolder> {
    ...
    // 어뎁터 생성 부분
    public Profile_Adapter(ArrayList<Item_DB> myDataset, View.OnClickListener onClick) {
        // 들어온 데이터 저장
        mDataset = myDataset;
    ...
    @Override
    public Profile_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        // create a new view
